...
export const PRESET_IMAGES: PresetImage[] = [
  {
    ...
    imageTitles: ["Slide 1 — Drone", "Slide 2 — Humanoid Robot", "Slide 3 — Robotic Dog", "Slide 4 — 3D Printer", "Slide 5 — Rover", "Slide 6 — JIDO Logo"],
    imageAnswers: ["Drone", "Humanoid Robot", "Robotic Dog", "3D Printer", "Rover", "JIDO"],
  ...
  {
    id:          "jido-img-3-roboticdog",
    url:         "/3.png",
    images:      ["/3.png"],
    imageTitles: ["Robotic Dog"],
    imageAnswers: ["Robotic Dog"],
    name:        "Round 3 — Robotic Dog",
    answer:      "Robotic Dog",
    category:    "Mobility",
    difficulty:  "Medium",
